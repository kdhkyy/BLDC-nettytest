...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                ...
                <div class="sidebar-brand-text mx-3">테스트</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">연결할 아이피 : 포트번호</h6>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="host" id="host" aria-describedby="IPHelp" placeholder="ip address....." maxlength="15">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="port" id="port" aria-describedby="PORTHelp" placeholder="port" maxlength="5">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">게이트 제어 테스트</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary btn-icon-split" style="margin: 10px">
                                <span class="text" value="STATUS">STATUS C</span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $(".card-body a span").click(function () {
                temp = $("#host").val();
                temp2 = $("#port").val();
